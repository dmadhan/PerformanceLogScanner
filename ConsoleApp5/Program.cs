    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            foreach (var ids in connDictionary)
            {
                ...
                //if (openTransactionCount != closedTransactionCount || openTransactionCount != disposedTransactionCount || closedTransactionCount != disposedTransactionCount)
                //{
                //    opeNotClosedNotDisposed.Add(new NotClosedNotDisposed
                //    {
                //        Guid = key,
                //        Message = "Stage connections do not match"
                //    });
                //}
                //else
                //{
            ...
            //foreach (var conn in connDictionary)
            //{
            //    var key = conn.Key;
            //    var transactions = conn.Value;
            ...
            //        {
            //            Guid = key,
            //            CloseDuration = openTime - closeTime
            //        });
